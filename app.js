...
var filtersIgnore = [
"cheminés","Davidson","ressort","gazon","lapierre","gamer","pneus","win10",
   "doudoune", "manger", "ampli", "amplificateur", "camescope", "casque", "casques", "classeur",
   "console", "consoles", "coolpix", "d-lux", "dlux", "enceinte", "enceintes", "finepix", "haut parleur",
   "jumelle", "laser", "lumix", "taille haie", "parabole", "montre",
   "perforateur", "médaille", "peugeot", "visseuse", "porte", "coulissante",
   "megapixel", "megapixels", "micro", "microscope", "minilux", "mixage", "nokia", "panasonic", "projecteur",
   "reparateur", "robot", "station", "telemetre", "disjoncteur", "telephone", "loue", "scanner",
   "clarinette", "moules", "fax", "numérique", "numerique", "informatique", "playmobil", "roue", "acer", "casques",
   "roue", "camping", "catamaran", "compteur électrique", "calculatrice", "encres", "encre", "billard", "chaise",
   "playmobil", "imprimante", "cartouche", "voiture", "vtt", "enceinte", "home cinéma", "laine", "tracteur",
   "tondeuse", "guitare", "vélo", "velo", "radiateur", "ikea", "trampoline", "bois", "medaille", "tonnelle",
   "canon 1Ds", "canon 5D", "canon 6D", "canon 7D", "canon D30", "canon D60", "canon 10D", "tuyau",
   "canon 20D", "canon 20Da", "canon 30D", "canon 40D", "canon 50D", "canon 60D", "canon 60Da", "canon 70D",
   "canon 77D", "canon 80D", "canon 300D", "canon DigitalRebel", "canon 350D", "canon RebelXT", "canon 400D",
   "canon RebelXTi", "canon 450D", "canon RebelXSi", "canon 500D", "canon RebelT1i", "canon 550D", "canon RebelT2i",
   "canon 600D", "canon RebelT3i", "canon 650D", "canon RebelT4i", "canon 700D", "canon RebelT5i", "canon 750D",
   "canon RebelT6i", "canon 760D", "canon RebelT6s", "canon 800D", "canon RebelT7i", "canon 1000D", "canon RebelXS",
   "canon 1100D", "canon RebelT3", "canon 1200D", "canon RebelT5", "canon 1300D", "canon RebelT6", "canon 100D",
   "vhs","vtt"
];
...
let querys = {
   "h": { "fav": true, "url": "samyang OR rokinon OR sony nex OR sony 6000 OR sony a6300 OR ilce OR sony a7 OR sony a7ii OR sony a7s OR sony fe" },
   "g": { "fav": true, "url": "contax OR contarex OR icarex OR FLEKTOGON OR Rolleiflex OR asahi" },
   "a": { "fav": false, "url": "35mm 1.2 OR 35mm 1.4 OR 35mm 1.8 OR 35mm 2 OR 35mm 2.8 OR 50mm 1.2 OR 50mm 1.4 OR 50mm 1.8 OR 50mm 2.8 OR 55mm 1.2 OR 55mm 1.4 OR 55mm 1.8 OR 55mm 2 OR 55mm 2.8 OR 50mm 2" },
   "j": { "fav": false, "url": "minolta OR zeiss OR olympus OR canon OR nikon OR rollei OR rokkor OR contax OR yashica OR leica OR pentax " },
   "b": { "fav": false, "url": "Contax OR Carl zeiss OR m42 OR bessa OR summicron OR argentique OR olympus om OR Minolta MD OR leicaflex OR leica" },
   "c": { "fav": false, "url": "konica OR hexar OR konica OR Yashica OR Yashika OR Contax OR distagon OR pentax OR rokkor OR carl zeiss OR summicron OR elmarit OR sony nex OR minolta OR leitz OR m42 OR bessa OR voigtlander OR nokton OR wetzlar OR olympus om OR Voigtlander OR leicaflex OR leica OR argentique NOT lumix NOT panasonic NOT telemetre NOT laser NOT robot NOT nokia NOT jumelle NOT camescope NOT station NOT Classeur NOT projecteur NOT microscope NOT reparateur NOT coolpix NOT dlux NOT d-lux NOT megapixel NOT DOLMEN NOT abricar" },
   "d": { "fav": false, "url": "50mm 1.2 OR 50mm 1.4 OR 50mm 1.6 OR 50mm 1.8 OR 50mm 2 OR 50mm 2.8 OR 50mm 3 OR 50mm 3.5 OR 50mm OR 52mm NOT lumix NOT panasonic NOT telemetre NOT laser NOT minilux NOT robot NOT nokia NOT jumelle NOT camescope NOT station NOT Classeur NOT projecteur NOT microscope NOT reparateur NOT coolpix NOT dlux NOT d-lux NOT megapixel NOT megapixels NOT mixage NOT ampli NOT finepix NOT amplificateur NOT camescope NOT enceinte NOT enceintes NOT micro NOT console NOT consoles NOT casques NOT casque NOT DOLMEN NOT abricar" },
   "e": { "fav": false, "url": "35mm 1.2 OR 35mm 1.4  OR 35mm 1.6  OR 35mm 1.8  OR 35mm 2  OR 35mm 2.8  OR 35mm 3  OR 35mm 3.5  OR 35mm OR 57mm OR 24mm" },
   "f": { "fav": false, "url": "50mm f1.2 OR  50mm F1,2 OR 50mm  F/1.2 OR 50mm F/1,2 OR 50mm 1:1,2 " },
   "i": { "fav": false, "url": "100mm f2 OR 100mm f2.8 OR 135mm f2 OR 85mm OR 200mm 2.8 OR 200mm 2 OR 300mm 2.8 OR 400mm 2.8 OR 16-35mm " }  
};
...
var createHtml = function (datafav, data) {
   ...
   var createAnnonceLi = function (annonce) {
      ...
      var htmltmp = '<li ><a target="_blank" href="' + annonce['link'] + '" title="' + annonce['title'] + '" class="list_item clearfix trackable" >';
      if (annonce['images'] != null && annonce['images'][0] != null) {
         htmltmp += '<div class="item_image"><img style="display:block;  max-width: 250px;max-height: 150px;" content="' + annonce['images'][0] + '" src="' + annonce['images'][0] + '"></div>';
      }

      var d = new Date(annonce['date']);
      htmltmp += '<section class="item_infos">' +
         '<h2 class="item_title" itemprop="name"> ' +
         annonce['title'] +
         '</h2>' +
         '<p >à ' +
         d.getHours() + ':' + d.getMinutes() + '   le  ' + d.getUTCDate() + '/' + d.getMonth() + '/' + d.getFullYear() + '<br>' + annonce['location']['department_name'] + " - " + annonce['location']['city'] +
         '</p>' +
...
function startProcessing(res){
   ...
   function getPage(idq, query, page, firstPageIds) {
      ...
      var search = new leboncoin.Search().setPage(page).setQuery(query["url"]).setFilter(leboncoin.FILTERS.PARTICULIER);
      /*
